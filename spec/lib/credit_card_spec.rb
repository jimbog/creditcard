...
describe CreditCard do
  it "is initialized with a hash" do
    cc = CreditCard.new name: "Tom", number: 4111111111111111, credit_line: 1000
    expect(cc.name).to eq("Tom")
    expect(cc.number).to eq(4111111111111111)
    expect(cc.balance).to eq(0)
  end

  it "is initialized with a balance of 0 if no credit line is passed in" do
  ...
  it "decreases the balance by the amount of credits" do
    cc = CreditCard.new name: "Lisa", number: 5454545454545454, credit_line: 3000
    cc.credit 100
